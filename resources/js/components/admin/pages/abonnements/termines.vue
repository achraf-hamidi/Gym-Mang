<template>
    <div class="main-panel">
        <div v-if="$can('Consulter les abonnements términés')" class="content-wrapper">
            ...
            <div class="row">
                <update-abonner :abonnements="abonnements" :packs="packs"></update-abonner>
            </div>
            <div class="row">
                    ...
                    <div class="card">
                        <div ref="formContainer" class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <h1 class="card-title">
                                        <i class="mdi-style-content mdi mdi mdi-clock-alert"></i>
                                        <span class="titre">Abonnements términés ( inactifs ) </span>
                                    </h1><br><br>
                                </div>
                                <div class="col-md-6">
                                    <p   class="text-right">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group mr-b-0em">
                                                    <label class="form__label">ID</label>
                                                     <input v-model="data_filtrer.id_empreinte" placeholder="Matricule" class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group mr-b-0em">
                            ...
                            <div class="row">
                                ...
                                <div v-if="filteredAbonnementsEnCours.length > 0" class="col-md-12 mt-5">
                                    <div style="overflow-x:auto;" id="packs" class="tab-pane fade in active show">
                                        <table id="data-packs" class="datatables table table-striped table-bordered table-hover">
                                            ...
                                            <tbody>
                                                <tr v-for="(adherent, index) in filteredAbonnementsEnCours">
                                                    <td>
                                                    ...
                                                    <td>
                                                        <router-link v-if="$can('Consulter la fiche d\'adhérent')" :to="{name: 'nouveau-abonnement', query:{matricule: adherent.code_client }}" class="btn btn-success mr-2">  Renouveler
                                                        </router-link>
...
export default {
    data() {
        return {
            ...
            datetimePicker: [null, null], //[new Date(new Date().getTime() - 1 * 24 * 60 * 60 * 1000), new Date(new Date().getTime() + 365 * 24 * 60 * 60 * 1000)],
    ...
    methods: {  
        ...
        AbonnementsEnCours(data_filtrer) {
            ...
            axios.post('/api-admin/abonners/encours-ou-termines?page=' + current_page, this.formData, config).then((response) => {
        ...
        SupprimerAbonnement(id_abonner, index) {
         ...
         clearDataInputs(){
            this.datetimePicker = [null, null] // [new Date(new Date().getTime() - 1 * 24 * 60 * 60 * 1000), new Date(new Date().getTime() + 365 * 24 * 60 * 60 * 1000)]
