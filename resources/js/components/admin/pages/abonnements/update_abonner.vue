                    ...
                    <div class="row">
                        <div class="col-md-11">
                            <div class="d-flex justify-content-between">
                                <h3 class="card-title mb-0">{{ $t('content.pages.abonnements.modifier.titre') }}</h3>
                            </div>
                        </div>
                        <div class="col-1">
                    ...
                    <form-wizard @on-complete="submit" subtitle="" title='' shape="circle" :back-button-text="$t('content.bouton.prev')" :next-button-text="$t('content.bouton.next')" :finish-button-text="$t('content.bouton.modifier')" color="#ff9c00e6">
                        <tab-content :title="$t('content.pages.adherents.add_modale.steps.infos')" icon="far fa-user">
                            <div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <h3>{{ $t('content.pages.abonnements.modifier.abonnement_actuel.titre') }}</h3>
                                    </div>
                                    <div class="col-md-6">
                                        <h3>{{ $t('content.pages.abonnements.modifier.abonnement_choisir.titre') }}</h3>
                                    </div>
                                </div><br>
                                <div class="row">
                                    <div class="col-md-6">
                                        <ul v-if="old_data_abonner.abonners" class="timeline">
                                            <li class="timeline-item">
                                                <p class="timeline-content"><b>{{ $t('content.pages.abonnements.modifier.abonnement_actuel.details.type_abonnement') }} : </b>{{ old_data_abonner.abonners[0].abonnements[0].libelle }}, {{ old_data_abonner.abonners[0].abonnements[0].nb_mois }} Mois</p>
                                            </li>
                                            <li class="timeline-item">
                                                <p class="timeline-content"><b>{{ $t('content.pages.abonnements.modifier.abonnement_actuel.details.type_pack') }} : </b>
                                                    {{ old_data_abonner.abonners[0].packs[0].description }}, {{ old_data_abonner.abonners[0].packs[0].prix }}
                                                </p>
                                            </li>
                                            <li class="timeline-item">
                                                <p class="timeline-content"><b>{{ $t('content.pages.abonnements.modifier.abonnement_actuel.details.remise') }} : </b>
                                                    {{ old_data_abonner.abonners[0].remise }}
                                                </p>
                                            </li>
                                            <li class="timeline-item">
                                                <p class="timeline-content"><b>{{ $t('content.pages.abonnements.modifier.abonnement_actuel.details.promotion') }} : </b>
                                                    {{ old_data_abonner.abonners[0].packs[0].pivot.promo }}
                                                </p>
                                            </li>
                                            <li class="timeline-item">
                                                <p class="timeline-content"><b>{{ $t('content.pages.abonnements.modifier.abonnement_actuel.details.montant_paye') }} : </b>
                                                    {{ t_paiements }} Dh
                                                </p>
                                            </li>
                                            <li class="timeline-item">
                                                <p class="timeline-content"><b>{{ $t('content.pages.abonnements.modifier.abonnement_actuel.details.retourner') }} : </b>
                                                    {{ t_ismoney }} Dh
                                                </p>
                                            </li>
                                            <li class="timeline-item">
                                                <p class="timeline-content"><b>{{ $t('content.pages.abonnements.modifier.abonnement_actuel.details.surcaisse') }} : </b>
                                                    {{ t_paiements - t_ismoney }} Dh
                                                </p>
                                            </li>
                                            <li class="timeline-item">
                                                <p class="timeline-content"><b>{{ $t('content.pages.abonnements.modifier.abonnement_actuel.details.net_paye') }} : </b>
                                                    {{ ActuelNetPaye }}
                                                </p>
                                            </li>
                                            <li class="timeline-item">
                                    ...
                                    <div class="col-md-6">
                                        <ul class="timeline">
                                            <li class="timeline-item">
                                                <p class="timeline-content"><b>{{ $t('content.pages.abonnements.modifier.abonnement_choisir.details.type_abonnement') }} : </b>
                                                    {{ this.$v.abonner.id_abonnement.$model.libelle }}, {{ this.$v.abonner.id_abonnement.$model.nb_mois }} Mois
                                                </p>
                                            </li>
                                            <li class="timeline-item">
                                                <p class="timeline-content"><b>{{ $t('content.pages.abonnements.modifier.abonnement_choisir.details.type_pack') }} : </b>
                                                    {{ this.$v.abonner.id_pack.$model.description }}, {{ this.$v.abonner.id_pack.$model.prix }}
                                                </p>
                                            </li>
                                            <li class="timeline-item">
                                                <p class="timeline-content"><b>{{ $t('content.pages.abonnements.modifier.abonnement_choisir.details.remise') }} : </b>
                                                    {{ this.$v.abonner.remise.$model }}
                                                </p>
                                            </li>
                                            <li class="timeline-item">
                                                <p class="timeline-content"><b>{{ $t('content.pages.abonnements.modifier.abonnement_choisir.details.promotion') }} : </b>
                                            ...
                                            <li class="timeline-item">
                                                <p class="timeline-content"><b>{{ $t('content.pages.abonnements.modifier.abonnement_choisir.details.net_paye') }} : </b>
                                                    {{ NouvelleNetPaye }}
                                                </p>
                                            </li>
                                            <li class="timeline-item">
                                                <p class="timeline-content"><b>{{ $t('content.pages.abonnements.modifier.abonnement_choisir.details.calcule_net_surcaisse') }}  : </b>
                            ...
                            <div class="row">
                                <div class="col-4">
                                    <div class="form-group mr-b-0em">
                                        <label class="form__label">{{ $t('content.pages.abonnements.modifier.inputs.packs') }} </label>
                                    ...
                                    <div v-if="$v.abonner.id_pack.$dirty">
                                        <div class="error" v-if="!$v.abonner.id_pack.required">{{ $t('validation.required', { attribute : $t('content.pages.abonnements.modifier.inputs.packs') } )  }}</div>
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="form-group mr-b-0em">
                                        <label class="form__label"> {{$t('content.pages.abonnements.modifier.inputs.abonnement')}}</label>
                                    ...
                                    <div v-if="$v.abonner.id_abonnement.$dirty">
                                        <div class="error" v-if="!$v.abonner.id_abonnement.required">{{ $t('validation.required', { attribute : $t('content.pages.abonnements.modifier.inputs.abonnement') }) }}</div>
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="form-group mr-b-0em" :class="{ 'form-group--error': $v.abonner.remise.$error }">
                                        <label class="form__label">{{$t('content.pages.abonnements.modifier.inputs.remise.titre')}}</label>
                                        <input class="form-control" v-model.trim="$v.abonner.remise.$model" @input="setremise($event.target.value)" @focusout="isRemiseNull" :placeholder="$t('content.pages.abonnements.modifier.inputs.remise.placeholder')" />
                                    </div>
                                    <div v-if="$v.abonner.remise.$dirty">
                                        <div class="error" v-if="!$v.abonner.remise.decimal">
                                            {{ $t('validation.numeric', { attribute : $t('content.pages.abonnements.modifier.inputs.remise.titre') }) }}
                                        </div>
                                    </div>
                                </div>
                            </div>
                   ...
                   this.AlertFire(this.action)
                    ...
                    if (result.value) {
                        ...
                        axios.post('/api-admin/abonners/update', this.formData, config).then(res => {
                                if (res.data) {
                                    const _text = this.$t('content.alerts.modification.success')  ; 

                                    this.AlertResponseTrue("",  _text , "success");  // message alert on response equals true
    ...
    computed: {
        ...
        NouvelleNetPaye() {
            ...
            if ( this.nb_mois_passe > this.nb_mois_choiser) {
                console.log(Total * this.nb_mois_passe)
