        ...
        <div class="card">
                    ...
                    <div class="col-md-12">
                        <div class="d-flex justify-content-between">
                            <h3 class="card-title mb-0">
                                Statistiques des inscriptions des 3 derniers mois (Abonnements vendus)
                            </h3>
                        </div>
                    </div>
                </div>
            ...
            <div class="card-body">
                <div v-if="loaded && charts.sums">
                    ...
                    <router-link  :to="{name: 'statistiques-abonnements-vendus'}" class="afficher-plus" >
...
export default {
    ...
    methods: {
        StatistiquesActuel() {
            axios.get('/api-admin/dashboard/statistiques-actuel').then((response) => {
