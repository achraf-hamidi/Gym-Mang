        ...
        <div class="card">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="d-flex justify-content-between">
                            <h3 class="card-title mb-0">Dépenses d'aujourd'hui </h3>
                        </div>
                    </div>
                </div>
            </div>
            <div class="card-body">
                <div v-if="loaded && charts.sums">
                    ...
                    <router-link  :to="{name: 'statistiques-depences'}" class="afficher-plus" >
