                    ...
                    <div class="auto-form-wrapper">
                        <div class="row">
                            <div style="text-align: center; margin-bottom: 45px;" class="col-md-12">
                                <img style="width: 80%;" src="{{ asset('/admin/logo1.png') }}">
                            </div>
                        </div>

                        <form method="POST" action="{{ route('login.adherent') }}">
                            @csrf
                            <div class="form-group">
                                <label class="label">Email professionnel</label>
                                <div class="input-group">
                                    <input placeholder="Email professionnel.." id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
                            ...
                            <div class="form-group">
                                <button class="btn btn-primary submit-btn btn-block">S'identifier</button>
                            </div>
